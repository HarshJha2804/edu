...
import logo from "../../assets/Empower-edu-logo.svg";
    ...
    <>
      ...
      >
        <nav className="flex justify-between px-8 py-4 items-center">
          ...
          <div
            className={`flex flex-row items-start justify-between p-4 pt-6 w-[100vw] md:hidden ${isOpen
          ...
          <ul className={`hidden md:flex flex-row gap-[1rem] items-center`}>
            ...
            <li>
              <NavLink
                ...
                className={({ isActive }: { isActive: any }) =>
                  ` ${isActive ? "font-normal" : ""}   ${scrolled ? "text-black" : "text-white"
                  } hover:text-opacity-70 text-[18px]`
                }
              >
            ...
            <li>
              ...
              >
                <Link to="/signup">
                  <button
                    className={`px-4 py-2 hover:ease-in-out border-[1px]  ${scrolled
