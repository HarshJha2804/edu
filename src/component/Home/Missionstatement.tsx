...
const Missionstatement = () => {
    return (
        <>
            <div className="container mx-auto px-8 md:px-16 flex justify-center items-center">
                <div className=" grid grid-cols-1 md:grid-cols-[1fr_1.3fr] gap-4 md:gap-10 bg-primary p-8 md:p-20  ">
                    ...
                    <div className="">
                        <p className="text-white text-[1rem] md:text-[1.25rem] font-light tracking-[0.05px] leading-[1.2rem] md:leading-[1.5rem]">
                            At EmpowerEdu, we work hand in hand with
                            educational institutions to offer specialised administrative and operational assistance, paired
