    ...
    return (
        <>
            <div className="container mx-auto">
                <div className="mx-8 md:px-8 md:py-16  bg-[#690500]">
                    <div className="grid grid-cols-1 md:grid-cols-[40%_auto] gap-4 md:justify-between md:gap-0">

                        <div className="grid grid-cols-[1fr_auto] gap-4 px-4 w-[fit-content] rounded-lg h-[max-content]">
                            <div className="grid">
