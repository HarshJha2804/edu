          ...
          <form className="form flex flex-col gap-16">
            <div>
              <svg height="2rem" viewBox="0 0 1127 140" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M329.42 47.29H348.65L375.22 109.5L404.24 47.29H417.17L443.74 109.5L485.35 17.46H470.31L444.09 76.7599L436.05 57.12L460.52 0H511.57L451.43 134.6H437.45L410.18 72.4L383.26 134.6H368.93L329.42 47.29Z" fill="#233C78" />
